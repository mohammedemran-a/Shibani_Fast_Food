...
export const AppSidebar: React.FC<AppSidebarProps> = ({ isOpen, onToggle }) => {
  ...
  const navItems: NavItem[] = [
    { label: t('nav.dashboard'), icon: LayoutDashboard, path: '/', permission: 'view_dashboard' },
    { label: t('nav.pos'), icon: ShoppingCart, path: '/pos', permission: 'access_pos' },
    {
      label: t('nav.products'),
      icon: Package,
      permission: 'view_products',
      children: [
        { label: t('nav.productsList'), icon: List, path: '/products', permission: 'view_products' },
        { label: t('nav.addProduct'), icon: Plus, path: '/products/add', permission: 'create_products' },
        { label: t('nav.importProducts'), icon: Upload, path: '/products/import', permission: 'import_products' },
      ],
    },
    { label: t('nav.sales'), icon: TrendingUp, path: '/sales', permission: 'view_sales' },
    { label: t('nav.purchases'), icon: ShoppingBag, path: '/purchases', permission: 'view_purchases' },
    { label: t('nav.expenses'), icon: Receipt, path: '/expenses', permission: 'view_expenses' },
    { label: t('nav.debts'), icon: Wallet, path: '/debts', permission: 'view_debts' },
    { label: t('nav.returns'), icon: RotateCcw, path: '/returns', permission: 'view_returns' },
    {
      label: t('nav.analytics'),
      icon: Lightbulb,
      permission: 'view_analytics',
      children: [
        { label: t('nav.basketAnalysis'), icon: ShoppingBasket, path: '/analytics/basket', permission: 'view_analytics' },
        { label: t('nav.productPerformance'), icon: Award, path: '/analytics/products', permission: 'view_analytics' },
      ],
    },
    {
      label: t('nav.reports'),
      ...
      children: [
        { label: t('nav.profitReport'), icon: DollarSign, path: '/reports/profit', permission: 'view_profit_report' },
        { label: t('nav.salesReport'), icon: FileText, path: '/reports/sales', permission: 'view_reports' },
        { label: t('nav.summaryReport'), icon: PieChart, path: '/reports/summary', permission: 'view_reports' },
      ],
    },
    {
      label: t('nav.people'),
      ...
      children: [
        { label: t('nav.customers'), icon: UserCircle, path: '/people/customers', permission: 'view_customers' },
        { label: t('nav.suppliers'), icon: Truck, path: '/people/suppliers', permission: 'view_suppliers' },
        { label: t('nav.users'), icon: UserCog, path: '/people/users', permission: 'view_users' },
      ],
    },
    {
      ...
      children: [
        { label: t('nav.attendance'), icon: Clock, path: '/employees/attendance', permission: 'view_attendance' },
        { label: t('nav.salesPerformance'), icon: Award, path: '/employees/performance', permission: 'view_sales_performance' },
      ],
    },
    {
      ...
      children: [
        { label: t('nav.generalSettings'), icon: Sliders, path: '/settings/general', permission: 'edit_settings' },
        { label: t('nav.loyaltySettings'), icon: Gift, path: '/settings/loyalty', permission: 'manage_loyalty_settings' },
        { label: t('nav.wallets'), icon: Wallet, path: '/settings/wallets', permission: 'manage_wallet_settings' },
        { label: t('nav.units'), icon: Scale, path: '/settings/units', permission: 'manage_units' },
        { label: t('nav.currencies'), icon: Coins, path: '/settings/currencies', permission: 'manage_currencies' },
        { label: t('nav.categories'), icon: Tags, path: '/settings/categories', permission: 'manage_categories' },
        { label: t('nav.brands'), icon: Bookmark, path: '/settings/brands', permission: 'manage_brands' },
        { label: t('nav.roles'), icon: Shield, path: '/settings/roles', permission: 'view_roles' },
      ],
    },
  ];
