...
import TablesLayoutPage from "@/pages/Table/TablesLayoutPage";
import "@/i18n";
        ...
        <Routes>
          ...
          <Route path="/kitchen" element={<KitchenDisplayPage />} />
            ...
            <Route
              ...
              element={
                <ProtectedRoute permission="edit_products">
                  <EditProduct />
                </ProtectedRoute>
              }
            />
            <Route
              ...
              element={
                <ProtectedRoute permission="import_products">
                  <ImportProducts />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              path="/purchases/add"
              element={
                <ProtectedRoute permission="create_purchases">
                  <AddPurchase />
                </ProtectedRoute>
              }
            />
            <Route
              path="/returns"
              element={
                <ProtectedRoute permission="view_returns">
                  <Returns />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              path="/debts"
              element={
                <ProtectedRoute permission="view_debts">
                  <DebtManagement />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              path="/reports/profit"
              element={
                <ProtectedRoute permission="view_profit_report">
                  <ProfitReport />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute permission="view_sales_performance">
            ...
            <Route
              ...
              element={
                <ProtectedRoute permission="edit_settings">
                  <GeneralSettings />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute permission="manage_currencies">
                  <Currencies />
                </ProtectedRoute>
              }
            />
            ...
            <Route
              ...
              element={
                <ProtectedRoute permission="manage_wallet_settings">
                  <WalletSettings />
                </ProtectedRoute>
              }
            />
            <Route
              ...
              element={
                <ProtectedRoute permission="manage_loyalty_settings">
                  <LoyaltySettings />
                </ProtectedRoute>
              }
            />
